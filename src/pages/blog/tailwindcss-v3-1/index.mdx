...
Here's an example combining the new `optional` modifier with our [sibling state features](/docs/hover-focus-and-other-states#estilo-basado-en-el-estado-del-hermano) to hide a little "Required" notice for fields that aren't required:
...
Well Tailwind CSS v3.1 introduces [arbitrary variants](/docs/hover-focus-and-other-states#usar-variantes-arbitrarias), letting you create your own ad hoc variants directly in your HTML:
