...
Exciting I know but also let's be serious [you've been able to add this yourself](https://tailwindcss.com/docs/responsive-design#personalizar-los-breakpoints) for like three years. Now it's blessed though, I get it.
