...
Learn more in the [accent color](/docs/accent-color) and [file input buttons](/docs/hover-focus-and-other-states#botones-de-entrada-de-archivos) documentation.
...
I'd say "learn more in the [print styles](/docs/hover-focus-and-other-states#estilos-de-impresion) documentation" but it wouldn't be true.
...
Learn more in the [RTL support](/docs/hover-focus-and-other-states#soporte-rtl) documentation.
...
The [documentation for this feature](/docs/hover-focus-and-other-states#orientacion-del-viewport) has even less content than this section of this post does.
