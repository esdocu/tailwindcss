...
Esto se resuelve fácilmente [extrayendo componentes y parciales](/docs/reusing-styles#extracting-components-and-partials) y usando [funciones del editor y del lenguaje](/docs/reusing-styles#using-editor-and-language-features) como la edición de múltiples cursores y bucles simples.
