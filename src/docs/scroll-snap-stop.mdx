...
export const description = "Utilidades para controlar si puedes omitir o pasar de largo posibles posiciones de ajuste de scroll.";
...
Utiliza la utilidad `snap-always` junto con la utilidad [snap-mandatory](/docs/scroll-snap-type#mandatory-scroll-snapping) para obligar a un contenedor snap a detenerse siempre en un elemento antes de que el usuario pueda continuar desplazándose al siguiente elemento:
