...
Utiliza utilidades `border-spacing-<number>` como `border-spacing-2` y `border-spacing-x-3` para controlar el espacio entre los bordes de las celdas de la tabla con [bordes separados](/docs/border-collapse#separating-table-borders):
...
<UsingACustomValue element="table" utility="border-spacing" value="7px" name="espaciado de borde" />
