...
export const description = "Utilidades para aplicar filtros grayscale a un elemento.";
...
Usa utilidades como `grayscale` y `grayscale-75` para controlar la cantidad de efecto grayscale aplicado a un elemento:
