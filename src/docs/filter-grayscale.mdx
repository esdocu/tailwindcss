...
export const description = "Utilidades para aplicar filtros de escala de grises (grayscale) a un elemento.";
...
Utiliza utilidades como `grayscale` y `grayscale-75` para controlar la cantidad de efecto de escala de grises aplicado a un elemento:
...
<UsingACustomValue element="img" elementAttributes={{ src: "/img/mountains.jpg" }} utility="grayscale" name="escala de grises" value="0.5" />
