...
export const description = "Utilidades para controlar el tamaño de los caracteres de tabulación.";
...
Usa utilidades `tab-<number>` como `tab-2` y `tab-8` para controlar el tamaño de los caracteres de tabulación:
