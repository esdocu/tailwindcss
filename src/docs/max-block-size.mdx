...
export const description = "Utilidades para establecer el tamaño de bloque máximo de un elemento.";
...
Utiliza utilidades `max-block-<number>` como `max-block-24` y `max-block-64` para establecer un tamaño de bloque máximo fijo para un elemento según la escala de espaciado:
...
Utiliza las utilidades `max-block-full` o `max-block-<fraction>` como `max-block-1/2` y `max-block-2/5` para dar a un elemento un tamaño de bloque máximo basado en porcentaje:
...
<UsingACustomValue utility="max-block" value="220px" name="tamaño de bloque máximo" variable="max-block-size" />
