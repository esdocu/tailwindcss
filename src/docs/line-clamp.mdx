...
export const description = "Utilidades para limitar el texto a un número específico de líneas.";
...
<Example padding={false}>
  {
    <div className="px-4 sm:px-0">
      <article className="mx-auto max-w-sm p-8 text-gray-700 dark:text-gray-400">
        ...
        <div className="mt-2 text-lg font-semibold text-gray-900 dark:text-gray-200">Aumenta tu tasa de conversión</div>
...
<article>
  ...
  <h2>Aumenta tu tasa de conversión</h2>
