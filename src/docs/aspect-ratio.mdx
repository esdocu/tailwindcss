...
Utiliza las utilidades <code>aspect-<var>&lt;ratio&gt;</var></code> como `aspect-3/2` para dar a un elemento una relación de aspecto específica:
...
### Utilizar una relación de aspecto de video

Utiliza la utilidad `aspect-video` para dar a un elemento de video una relación de aspecto de 16 / 9:
