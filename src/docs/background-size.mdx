...
export const description = "Utilidades para controlar el tamaño de fondo de la imagen de fondo de un elemento.";
...
<UsingACustomValue utility="bg-size" value="auto_100px" name="tamaño de fondo" variable="image-size" />
