...
export const description = "Utilidades para controlar el cuadro delimitador del fondo de un elemento.";
...
Utiliza las utilidades `bg-clip-border`, `bg-clip-padding` y `bg-clip-content` para controlar el cuadro delimitador del fondo de un elemento:
...
Utiliza la utilidad `bg-clip-text` para recortar el fondo de un elemento y hacer que coincida con la forma del texto:
