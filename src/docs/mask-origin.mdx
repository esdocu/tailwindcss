...
export const description =
  "Utilidades para controlar cómo se posiciona la imagen de máscara de un elemento en relación con los bordes, el relleno y el contenido.";
...
Utiliza utilidades como `mask-origin-border`, `mask-origin-padding` y `mask-origin-content` para controlar dónde se renderiza la máscara de un elemento:
