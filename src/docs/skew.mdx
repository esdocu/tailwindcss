...
export const description = "Utilidades para inclinar (skew) elementos con transform.";
...
Utiliza utilidades `skew-<number>` como `skew-4` y `skew-10` para inclinar un elemento en ambos ejes:
...
Utiliza utilidades `-skew-<number>` como `-skew-4` y `-skew-10` para inclinar un elemento en ambos ejes con valores negativos:
...
### Inclinar en el eje x

Utiliza utilidades `skew-x-<number>` como `skew-x-4` y `-skew-x-10` para inclinar un elemento en el eje x:
...
Utiliza utilidades `skew-y-<number>` como `skew-y-4` y `-skew-y-10` para inclinar un elemento en el eje y:
