...
export const description = "Utilidades para sesgar elementos con transform.";
...
Usa utilidades `skew-<number>` como `skew-4` y `skew-10` para sesgar un elemento en ambos ejes:
...
### Sesgando en el eje x

Usa utilidades `skew-x-<number>` como `skew-x-4` y `-skew-x-10` para sesgar un elemento en el eje x:
...
### Sesgando en el eje y

Usa utilidades `skew-y-<number>` como `skew-y-4` y `-skew-y-10` para sesgar un elemento en el eje y:
