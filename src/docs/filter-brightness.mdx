...
export const description = "Utilidades para aplicar filtros de brillo (brightness) a un elemento.";
...
Utiliza utilidades como `brightness-50` y `brightness-100` para controlar el brillo de un elemento:
...
<UsingACustomValue element="img" elementAttributes={{ src: "/img/mountains.jpg" }} utility="brightness" name="brillo" value="1.75" />
