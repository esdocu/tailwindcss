...
export const description = "Utilidades para aplicar filtros brightness a un elemento.";
...
Usa utilidades como `brightness-50` y `brightness-100` para controlar el brillo de un elemento:
