...
export const description = "Utilidades para aplicar filtros de rotación de tono de fondo a un elemento.";
...
Usa utilidades como `backdrop-hue-rotate-90` y `backdrop-hue-rotate-180` para rotar el tono del fondo de un elemento:
...
Usa utilidades como `-backdrop-hue-rotate-90` y `-backdrop-hue-rotate-180` para establecer un valor negativo de rotación de tono de fondo:
