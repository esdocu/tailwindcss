...
Utiliza utilidades como `border-solid` y `border-dotted` para controlar el estilo de borde de un elemento:
...
Utiliza la utilidad `border-none` para eliminar un borde existente de un elemento:
...
Esto se usa más comúnmente para eliminar un estilo de borde que se aplicó en un punto de interrupción más pequeño.

### Establecer el estilo del divisor

Utiliza utilidades como `divide-dashed` y `divide-dotted` para controlar el estilo de borde entre los elementos hijos:
