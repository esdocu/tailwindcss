...
export const description = "Utilidades para aplicar filtros de inversión de fondo a un elemento.";
...
Utiliza utilidades como `backdrop-invert` y `backdrop-invert-65` para controlar la inversión de color del fondo de un elemento:
...
<UsingACustomValue utility="backdrop-invert" value=".25" name="inversión de fondo" variable="backdrop-inversion" />
