...
export const description = "Utilidades para aplicar filtros de sepia de fondo a un elemento.";
...
Utiliza utilidades como `backdrop-sepia` y `backdrop-sepia-50` para controlar el efecto sepia aplicado al fondo de un elemento:
...
<UsingACustomValue utility="backdrop-sepia" value=".25" name="sepia de fondo" />
