...
Para esas situaciones, es mejor utilizar las [utilidades de gap](/docs/gap) cuando sea posible, o añadir margen a cada elemento con un margen negativo coincidente en el contenedor padre.

Además, las utilidades de espacio no están diseñadas para funcionar junto con las [utilidades divide](/docs/border-width#between-children). Para esas situaciones, considera añadir utilidades de margen/relleno (padding) a los elementos hijos en su lugar.
