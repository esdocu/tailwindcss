...
export const description = "Utilidades para aplicar filtros de opacidad de fondo a un elemento.";
...
Utiliza utilidades como `backdrop-opacity-10` y `backdrop-opacity-60` para controlar la opacidad de todos los filtros de fondo aplicados a un elemento:
...
<UsingACustomValue
  ...
  value=".15"
  name="opacidad del filtro de fondo"
