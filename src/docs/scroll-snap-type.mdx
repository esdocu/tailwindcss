...
export const description = "Utilidades para controlar con qué rigidez se aplican los puntos de ajuste (snap points) en un contenedor snap.";
...
Para que el ajuste de scroll funcione, también debes establecer la [alineación del ajuste de scroll](/docs/scroll-snap-align) en los elementos hijos.

### Ajuste de scroll obligatorio (mandatory)
...
### Ajuste de scroll por proximidad

Utiliza la utilidad `snap-proximity` para hacer que un contenedor snap se detenga en los puntos de ajuste cercanos por proximidad:
