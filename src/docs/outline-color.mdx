...
Utiliza utilidades como `outline-rose-500` and `outline-lime-100` para controlar el color del contorno de un elemento:
...
<button class="outline-2 outline-offset-2 outline-blue-500 ...">Botón A</button>
<button class="outline-2 outline-offset-2 outline-cyan-500 ...">Botón B</button>
<button class="outline-2 outline-offset-2 outline-pink-500 ...">Botón C</button>
```
...
Utiliza el modificador de opacidad de color para controlar la opacidad del color del contorno de un elemento:
...
<!-- [!code word:/75] -->
<!-- [!code word:/50] -->
<button class="outline-2 outline-blue-500/100 ...">Botón A</button>
<button class="outline-2 outline-blue-500/75 ...">Botón B</button>
<button class="outline-2 outline-blue-500/50 ...">Botón C</button>
```
...
<UsingACustomValue utility="outline" name="color del contorno" value="#243c5a" variable="color" />
