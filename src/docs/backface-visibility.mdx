...
export const description = "Utilidades para controlar si la cara posterior de un elemento es visible.";
...
Utiliza la utilidad `backface-visible` para mostrar la cara posterior de un elemento, como un cubo, incluso cuando está rotado fuera de la vista:
