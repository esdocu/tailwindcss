...
export const description = "Utilidades para aplicar filtros de saturación (saturate) a un elemento.";
...
Utiliza utilidades como `saturate-50` y `saturate-100` para controlar la saturación de un elemento:
