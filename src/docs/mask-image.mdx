...
<Example padding={false}>
  {
    <div className="mx-auto flex items-center p-16 max-sm:p-6">
      ...
      <div className="font-medium max-sm:-mx-3">
        ...
        <p className="mt-2 text-base whitespace-nowrap text-gray-700 dark:text-gray-300">Diseñado para usuarios avanzados</p>
...
<div class="flex items-center gap-4">
  ...
  <div class="font-medium">
    ...
    <p class="mt-2 text-base text-gray-700 dark:text-gray-300">Diseñado para usuarios avanzados</p>
    <p class="mt-1 text-sm leading-relaxed text-balance text-gray-500">
      Trabaja más rápido que nunca con atajos de teclado personalizables
    </p>
  </div>
</div>
```
...
Esto es diferente de [`mask-position`](/docs/mask-position), que establece la posición de la propia imagen de máscara, no del degradado radial.
...
Este comportamiento se basa en el hecho de que Tailwind establece la [propiedad `mask-composite`](/docs/mask-composite) en `intersect` por defecto. Cambiar esta propiedad afectará a cómo se combinan las máscaras de degradado.
