...
export const description = "Utilidades para aplicar filtros de desenfoque (blur) a un elemento.";
...
<UsingACustomValue element="img" elementAttributes={{ src: "/img/mountains.jpg" }} utility="blur" name="desenfoque" value="2px" />
