...
Utiliza la utilidad `animate-spin` para añadir una animación de rotación lineal a elementos como indicadores de carga:
...
### Añadir una animación de ping

Utiliza la utilidad `animate-ping` para hacer que un elemento se escale y se desvanezca como un pulso de radar o una onda de agua; útil para cosas como insignias de notificación:
...
Utiliza la utilidad `animate-pulse` para hacer que un elemento se desvanezca suavemente hacia adentro y hacia afuera; útil para cosas como cargadores de esqueleto:
...
### Añadir una animación de rebote

Utiliza la utilidad `animate-bounce` para hacer que un elemento rebote hacia arriba y hacia abajo; útil para cosas como indicadores de "desplazarse hacia abajo":
...
### Soportar movimiento reducido

Para situaciones en las que el usuario ha especificado que prefiere un movimiento reducido, puedes aplicar animaciones y transiciones condicionalmente utilizando las variantes `motion-safe` y `motion-reduce`:
