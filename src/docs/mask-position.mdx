...
export const description = "Utilidades para controlar la posición de la imagen de máscara de un elemento.";
...
Utiliza utilidades como `mask-center`, `mask-right` y `mask-left-top` para controlar la posición de la imagen de máscara de un elemento:
...
<UsingACustomValue utility="mask-position" value="center_top_1rem" name="posición de máscara" variable="mask-position" />
