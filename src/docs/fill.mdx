...
export const description = "Utilidades para estilizar el relleno (fill) de elementos SVG.";
...
<Figure hint="Pasa el mouse sobre el botón para ver cambiar el color de relleno">
...
<UsingACustomValue element="svg" utility="fill" name="color de relleno" value="#243c5a" variable="fill-color" />
