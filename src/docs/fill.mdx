...
export const description = "Utilidades para estilizar el relleno de elementos SVG.";
...
<Figure hint="Pasa el ratón sobre el botón para ver el cambio de color de relleno">
