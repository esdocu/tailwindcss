...
Usa utilidades como `bg-linear-to-r` y `bg-linear-<angle>` con las [utilidades de parada de color](#estableciendo-paradas-de-color-del-degradado) para añadir un degradado lineal a un elemento:
...
Usa las utilidades `bg-radial` y `bg-radial-[<position>]` con las [utilidades de parada de color](#estableciendo-paradas-de-color-del-degradado) para añadir un degradado radial a un elemento:
...
Usa las utilidades `bg-conic` y `bg-conic-<angle>` con las [utilidades de parada de color](#estableciendo-paradas-de-color-del-degradado) para añadir un degradado cónico a un elemento:
