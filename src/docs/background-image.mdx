...
export const description = "Utilidades para controlar la imagen de fondo de un elemento.";
...
Utiliza la sintaxis `bg-[<value>]` para establecer la imagen de fondo de un elemento:
...
### Añadir un gradiente lineal

Utiliza utilidades como `bg-linear-to-r` y `bg-linear-<angle>` con las [utilidades de paradas de color](#configurar-las-paradas-de-color-del-gradiente) para añadir un gradiente lineal a un elemento:
...
### Añadir un gradiente radial

Utiliza las utilidades `bg-radial` y `bg-radial-[<position>]` con las [utilidades de paradas de color](#configurar-las-paradas-de-color-del-gradiente) para añadir un gradiente radial a un elemento:
...
### Añadir un gradiente cónico

Utiliza las utilidades `bg-conic` y `bg-conic-<angle>` con las [utilidades de paradas de color](#configurar-las-paradas-de-color-del-gradiente) para añadir un gradiente cónico a un elemento:
...
### Configurar las paradas de color del gradiente

Utiliza utilidades como `from-indigo-500`, `via-purple-500` y `to-pink-500` para configurar los colores de las paradas de gradiente:
...
### Configurar las posiciones de parada del gradiente

Utiliza utilidades como `from-10%`, `via-30%` y `to-90%` para establecer posiciones más precisas para las paradas de color del gradiente:
...
Utiliza el modificador de interpolación para controlar el modo de interpolación de un gradiente:
...
Por defecto, los gradientes se interpolan en el espacio de color `oklab`.

### Eliminar imágenes de fondo

Utiliza la utilidad `bg-none` para eliminar una imagen de fondo existente de un elemento:
