...
export const description =
  "Utilidades para controlar cómo se debe posicionar el contenido de un elemento reemplazado dentro de su contenedor.";
...
Utiliza utilidades como `object-left` y `object-bottom-right` para especificar cómo se debe posicionar el contenido de un elemento reemplazado dentro de su contenedor:

<Figure hint="Pasa el cursor sobre los ejemplos para ver la imagen completa">
