...
Usa utilidades como `object-left` y `object-bottom-right` para especificar cómo se debe posicionar el contenido de un elemento reemplazado dentro de su contenedor:
