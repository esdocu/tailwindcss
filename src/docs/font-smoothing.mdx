...
export const description = "Utilidades para controlar el suavizado de fuente (font-smoothing) de un elemento.";
...
### Suavizado por escala de grises

Utiliza la utilidad `antialiased` para renderizar texto usando suavizado por escala de grises:
...
<p class="antialiased ...">El veloz zorro marrón ...</p>
```

</Figure>

### Suavizado por subpíxeles

Utiliza la utilidad `subpixel-antialiased` para renderizar texto usando suavizado por subpíxeles:
...
<p class="subpixel-antialiased ...">El veloz zorro marrón ...</p>
```
