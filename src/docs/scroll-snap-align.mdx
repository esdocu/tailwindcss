...
export const description = "Utilidades para controlar la alineación del punto de ajuste de scroll (scroll snap) de un elemento.";
...
Utiliza la utilidad `snap-center` para ajustar un elemento a su centro al desplazarse dentro de un contenedor snap:
...
Utiliza la utilidad `snap-start` para ajustar un elemento a su inicio al desplazarse dentro de un contenedor snap:
...
Utiliza la utilidad `snap-end` para ajustar un elemento a su final al desplazarse dentro de un contenedor snap:
