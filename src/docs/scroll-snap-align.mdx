...
export const description = "Utilidades para controlar la alineación del snap del scroll de un elemento.";
...
Usa la utilidad `snap-start` para ajustar un elemento a su inicio cuando se desplaza dentro de un contenedor snap:
...
Usa la utilidad `snap-end` para ajustar un elemento a su final cuando se desplaza dentro de un contenedor snap:
