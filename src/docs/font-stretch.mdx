...
export const description = "Utilidades para seleccionar el ancho de una tipografía.";
...
Utiliza utilidades como `font-stretch-condensed` y `font-stretch-expanded` para establecer el ancho de una tipografía:
...
<p class="font-stretch-extra-condensed">El veloz zorro marrón...</p>
<p class="font-stretch-condensed">El veloz zorro marrón...</p>
<p class="font-stretch-normal">El veloz zorro marrón...</p>
<p class="font-stretch-expanded">El veloz zorro marrón...</p>
<p class="font-stretch-extra-expanded">El veloz zorro marrón...</p>
```
...
Utiliza utilidades `font-stretch-<percentage>` como `font-stretch-50%` y `font-stretch-125%` para establecer el ancho de una tipografía usando un porcentaje:
...
<p class="font-stretch-50%">El veloz zorro marrón...</p>
<p class="font-stretch-100%">El veloz zorro marrón...</p>
<p class="font-stretch-150%">El veloz zorro marrón...</p>
```
...
<UsingACustomValue element="p" utility="font-stretch" value="66.66%" name="ancho de tipografía" variable="font-width" />
