...
export const description = "Utilidades para controlar si los bordes de la tabla deben colapsar o separarse.";
...
### Colapsar bordes de tabla

Utiliza la utilidad `border-collapse` para combinar bordes de celdas adyacentes en un solo borde cuando sea posible:
...
Ten en cuenta que esto incluye colapsar los bordes en la etiqueta `<table>` de nivel superior.

### Separar bordes de tabla

Utiliza la utilidad `border-separate` para forzar a cada celda a mostrar sus propios bordes separados:
