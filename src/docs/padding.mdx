...
Para un mayor control, también puedes utilizar los [modificadores LTR y RTL](/docs/hover-focus-and-other-states#rtl-support) para aplicar estilos específicos de forma condicional según la dirección actual del texto.
