...
export const description = "Utilidades para controlar el tamaño inicial de los elementos flex.";
...
Utiliza utilidades `basis-<number>` como `basis-64` y `basis-128` para establecer el tamaño inicial de los elementos flex según la escala de espaciado:
...
Utiliza utilidades como `basis-xs` y `basis-sm` para establecer el tamaño inicial de los elementos flex según la escala de contenedores:
...
Utiliza utilidades `basis-<fraction>` como `basis-1/2` y `basis-2/3` para establecer el tamaño inicial de los elementos flex:
...
<CustomizingYourTheme
  utility="basis"
  themeKey="container"
  name="tamaño inicial de ancho fijo"
  customName="4xs"
  customValue="14rem"
  includeSpacingNote
/>
