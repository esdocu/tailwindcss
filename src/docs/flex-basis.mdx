...
Usa utilidades `basis-<number>` como `basis-64` y `basis-128` para establecer el tamaño inicial de los elementos flex según la escala de espaciado:
...
### Usando la escala de contenedor

Usa utilidades como `basis-xs` y `basis-sm` para establecer el tamaño inicial de los elementos flex según la escala de contenedor:
...
Usa utilidades `basis-<fraction>` como `basis-1/2` y `basis-2/3` para establecer el tamaño inicial de los elementos flex:
