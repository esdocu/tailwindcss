...
export const description =
  "Utilidades para controlar cómo se deben renderizar los fragmentos de un elemento en varias líneas, columnas o páginas.";
...
Utiliza las utilidades `box-decoration-slice` y `box-decoration-clone` para controlar si las propiedades como background, border, border-image, box-shadow, clip-path, margin y padding se deben renderizar como si el elemento fuera un fragmento continuo o bloques distintos:
