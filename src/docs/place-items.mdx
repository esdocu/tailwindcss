...
Utiliza `place-items-start` para colocar los elementos de la cuadrícula al inicio de sus áreas de cuadrícula en ambos ejes:
...
Utiliza `place-items-end` para colocar los elementos de la cuadrícula al final de sus áreas de cuadrícula en ambos ejes:
...
Utiliza `place-items-center` para colocar los elementos de la cuadrícula en el centro de sus áreas de cuadrícula en ambos ejes:
...
Utiliza `place-items-stretch` para estirar los elementos a lo largo de sus áreas de cuadrícula en ambos ejes:
