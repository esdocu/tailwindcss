...
export const description = "Utilidades para controlar la posición de la imagen de fondo de un elemento.";
...
Utiliza utilidades como `bg-center`, `bg-right` y `bg-top-left` para controlar la posición de la imagen de fondo de un elemento:

<Figure hint="Pasa el cursor sobre estos ejemplos para ver la imagen completa">
...
<UsingACustomValue utility="bg-position" value="center_top_1rem" name="posición de fondo" variable="bg-position" />
