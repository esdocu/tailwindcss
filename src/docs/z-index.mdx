...
Usa las utilidades `z-<number>` como `z-10` y `z-50` para controlar el orden de apilamiento (o posicionamiento tridimensional) de un elemento, independientemente del orden en que se muestre:
...
Para usar un valor de z-index negativo, antepone un guión al nombre de la clase para convertirlo en un valor negativo:
...
<UsingACustomValue utility="z" name="orden de apilamiento" value="calc(var(--index)+1)" />
