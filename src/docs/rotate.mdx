...
export const description = "Utilidades para rotar elementos.";
...
Utiliza utilidades `rotate-<number>` como `rotate-45` y `rotate-90` para rotar un elemento en grados:
...
Utiliza utilidades `-rotate-<number>` como `-rotate-45` y `-rotate-90` para rotar un elemento en sentido contrario a las agujas del reloj en grados:
...
### Rotación en espacio 3D

Utiliza utilidades `rotate-x-<number>`, `rotate-y-<number>` y `rotate-z-<number>` como `rotate-x-50`, `-rotate-y-30` y `rotate-z-45` en conjunto para rotar un elemento en el espacio 3D:
