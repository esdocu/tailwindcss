...
Usa utilidades `rotate-<number>` como `rotate-45` y `rotate-90` para rotar un elemento en grados:
...
Usa utilidades `-rotate-<number>` como `-rotate-45` y `-rotate-90` para rotar un elemento en sentido antihorario en grados:
...
Usa utilidades `rotate-x-<number>`, `rotate-y-<number>`, y `rotate-z-<number>` como `rotate-x-50`, `-rotate-y-30`, y `rotate-z-45` juntas para rotar un elemento en espacio 3D:
