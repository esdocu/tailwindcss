...
export const description = "Utilidades para controlar el origen de perspectiva de un elemento al colocarlo en un espacio 3D.";
...
Utiliza utilidades como `perspective-origin-top` y `perspective-origin-bottom-left` para controlar dónde se encuentra el punto de fuga de una perspectiva:
...
<UsingACustomValue utility="perspective-origin" value="200%_150%" name="origen de perspectiva" />
