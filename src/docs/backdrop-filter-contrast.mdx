...
Utiliza utilidades como `backdrop-contrast-50` y `backdrop-contrast-200` para controlar el contraste de fondo de un elemento:
...
<UsingACustomValue utility="backdrop-contrast" value=".25" name="contraste de fondo" />
