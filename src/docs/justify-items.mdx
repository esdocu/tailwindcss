...
export const description = "Utilidades para controlar cómo se alinean los elementos de la cuadrícula a lo largo de su eje en línea.";
...
Utiliza la utilidad `justify-items-start` para alinear los elementos de la cuadrícula contra el inicio de su eje en línea:
...
Utiliza las utilidades `justify-items-end` o `justify-items-end-safe` para alinear los elementos de la cuadrícula contra el final de su eje en línea:
...
Cuando no haya suficiente espacio disponible, la utilidad `justify-items-end-safe` alineará los elementos al inicio del contenedor en lugar de al final.

### Centrado (Center)

Utiliza las utilidades `justify-items-center` o `justify-items-center-safe` para alinear los elementos de la cuadrícula contra el centro de su eje en línea:
...
Cuando no haya suficiente espacio disponible, la utilidad `justify-items-center-safe` alineará los elementos al inicio del contenedor en lugar de al centro.

### Estirar (Stretch)

Utiliza la utilidad `justify-items-stretch` para estirar los elementos a lo largo de su eje en línea:
