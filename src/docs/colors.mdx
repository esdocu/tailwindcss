...
export const title = "Colores";
export const description = "Uso y personalización de la paleta de colores en proyectos de Tailwind CSS.";

Tailwind CSS incluye una amplia y hermosa paleta de colores lista para usar, cuidadosamente diseñada por diseñadores expertos y adecuada para una amplia gama de diferentes estilos de diseño.
...
Cada color en la paleta predeterminada incluye 11 pasos, siendo 50 el más claro y 950 el más oscuro:
...
La paleta de colores completa está disponible en todas las utilidades relacionadas con el color, incluyendo cosas como [color de fondo](/docs/background-color), [color de borde](/docs/border-color), [relleno](/docs/fill), [color de cursor](/docs/caret-color) y muchos más.

## Trabajo con colores

### Uso de utilidades de color

Utiliza utilidades de color como `bg-white`, `border-pink-300` y `text-gray-950` para establecer las diferentes propiedades de color de los elementos en tu diseño:
      ...
      <div className="mx-auto flex max-w-md items-center gap-4 rounded-lg bg-white p-6 shadow-md outline outline-black/5 dark:bg-gray-800">
        ...
        <div>
          <p className="text-gray-700 dark:text-gray-400">
            <span className="font-medium text-gray-950 dark:text-white">Tom Watson</span> te mencionó en{" "}
            <span className="font-medium text-gray-950 dark:text-white">Rediseño de Logo</span>
          </p>
...
<div class="flex items-center gap-4 rounded-lg bg-white p-6 shadow-md outline outline-black/5 dark:bg-gray-800">
  ...
  <div>
    <p class="text-gray-700 dark:text-gray-400">
      <span class="font-medium text-gray-950 dark:text-white">Tom Watson</span> te mencionó en
      <span class="font-medium text-gray-950 dark:text-white">Rediseño de Logo</span>
    </p>
...
Aquí hay una lista completa de utilidades que utilizan tu paleta de colores:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Establece el <a href="/docs/background-color">color de fondo</a> de un elemento
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/text-color">color de texto</a> de un elemento
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/text-decoration-color">color de decoración de texto</a> de un elemento
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/border-color">color de borde</a> de un elemento
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/outline-color">color de contorno</a> de un elemento
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el color de las <a href="/docs/box-shadow#setting-the-shadow-color">sombras de caja</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el color de las <a href="/docs/box-shadow#setting-the-inset-shadow-color">sombras de caja interiores (inset)</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el color de las <a href="/docs/box-shadow#setting-the-ring-color">sombras de anillo (ring)</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el color de las <a href="/docs/box-shadow#setting-the-inset-ring-color">sombras de anillo interiores (inset)</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/accent-color">color de acento</a> de los controles de formulario
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/caret-color">color del cursor</a> en los controles de formulario
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/scrollbar-color">color del control deslizante (thumb)</a> de la barra de desplazamiento de un elemento
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/scrollbar-color">color de la pista (track)</a> de la barra de desplazamiento de un elemento
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/fill">color de relleno</a> de elementos SVG
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Establece el <a href="/docs/stroke">color de trazo</a> de elementos SVG
      </td>
    </tr>
  </tbody>
</table>
...
### Orientar al modo oscuro

Utiliza la variante `dark` para escribir clases como `dark:bg-gray-800` que solo aplican un color cuando el modo oscuro está activo:
...
Obtén más información sobre los estilos para el modo oscuro en la [documentación del modo oscuro](/docs/dark-mode).

### Referenciar en CSS

Los colores se exponen como variables CSS en el espacio de nombres de tema `--color-*`, por lo que puedes hacer referencia a ellos en CSS con variables como `--color-blue-500` y `--color-pink-700`:
...
También puedes usarlos como [valores arbitrarios]() en clases de utilidad:
...
Para ajustar rápidamente la opacidad de un color al hacer referencia a él como una variable en CSS, Tailwind incluye una función especial `--alpha()`:
...
Utiliza `@theme` para agregar colores personalizados a tu proyecto bajo el espacio de nombres de tema `--color-*`:
...
Obtén más información sobre las variables de tema en la [documentación de variables de tema](/docs/theme).

### Anular colores predeterminados
...
### Desactivar colores predeterminados

Desactiva cualquier color predeterminado estableciendo el espacio de nombres del tema para ese color en `initial`:
...
Esto es especialmente útil para eliminar las variables CSS correspondientes de tu salida para los colores que no tienes la intención de usar.

### Uso de una paleta personalizada

Utiliza `--color-*: initial` para desactivar por completo todos los colores predeterminados y definir tu propia paleta de colores personalizada:
...
Utiliza `@theme inline` al definir colores que hacen referencia a otros colores:
...
Obtén más información en la documentación de temas sobre cómo [referenciar otras variables](/docs/theme#referencing-other-variables).

## Referencia de la paleta de colores predeterminada

Aquí hay una lista completa de los colores predeterminados y sus valores para referencia:
...
Esto puede ser útil si deseas reutilizar cualquiera de estas escalas pero con un nombre diferente, como redefinir `--color-gray-*` para usar la escala `--color-slate-*`.
