...
export const description = "Utilidades para aplicar filtros de contraste (contrast) a un elemento.";
...
Utiliza utilidades como `contrast-50` y `contrast-100` para controlar el contraste de un elemento:
...
<UsingACustomValue element="img" elementAttributes={{ src: "/img/mountains.jpg" }} utility="contrast" name="contraste" value=".25" />
