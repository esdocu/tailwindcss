...
export const description = "Utilidades para aplicar filtros contrast a un elemento.";
...
Usa utilidades como `contrast-50` y `contrast-100` para controlar el contraste de un elemento:
