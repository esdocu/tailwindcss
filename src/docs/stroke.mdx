...
export const description = "Utilidades para dar estilo al trazo (stroke) de elementos SVG.";
...
Utiliza utilidades como `stroke-indigo-500` y `stroke-lime-600` para cambiar el color de trazo de un SVG:
...
Esto puede ser útil para dar estilo a conjuntos de iconos como [Heroicons](https://heroicons.com).

### Uso del color actual (current)

Utiliza la utilidad `stroke-current` para establecer el color de trazo al color del texto actual:

<Figure hint="Pasa el cursor sobre el botón para ver cambiar el color de trazo">
