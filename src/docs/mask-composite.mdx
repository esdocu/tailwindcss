...
export const description = "Utilidades para controlar cómo se combinan múltiples máscaras juntas.";
...
Utiliza utilidades como `mask-add` y `mask-intersect` para controlar cómo se combinan las máscaras de un elemento:
