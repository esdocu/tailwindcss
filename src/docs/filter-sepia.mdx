...
export const description = "Utilidades para aplicar filtros sepia a un elemento.";
...
Utiliza utilidades como `sepia` y `sepia-50` para controlar el efecto sepia aplicado a un elemento:
