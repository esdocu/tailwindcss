...
Utiliza utilidades como `backdrop-brightness-50` y `backdrop-brightness-150` para controlar el brillo de fondo de un elemento:
...
<UsingACustomValue utility="backdrop-brightness" value="1.75" name="brillo de fondo" />
