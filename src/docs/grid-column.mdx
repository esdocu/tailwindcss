...
export const description = "Utilidades para controlar cómo se dimensionan y colocan los elementos en las columnas de la cuadrícula.";
...
Usa utilidades `col-span-<number>` como `col-span-2` y `col-span-4` para hacer que un elemento ocupe _n_ columnas:
...
Usa las utilidades `col-start-<number>` o `col-end-<number>` como `col-start-2` y `col-end-3` para hacer que un elemento comience o termine en la _n-ésima_ línea de la cuadrícula:
...
Estas también se pueden combinar con las utilidades `col-span-<number>` para abarcar un número específico de columnas.
