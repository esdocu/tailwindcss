...
export const description = "Utilidades para aplicar filtros hue-rotate a un elemento.";
...
Usa utilidades como `-hue-rotate-15` y `-hue-rotate-45` para establecer un valor negativo de rotación de matiz:
