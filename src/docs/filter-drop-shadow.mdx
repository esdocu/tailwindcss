...
export const description = "Utilidades para aplicar filtros drop-shadow a un elemento.";
...
Esto es útil para aplicar sombras a formas irregulares, como texto y elementos SVG. Para aplicar sombras a elementos regulares, probablemente quieras usar [box shadow](/docs/box-shadow) en su lugar.
