...
export const description = "Utilidades para controlar cómo debe calcular el navegador el tamaño total de un elemento.";
...
Tailwind hace que esto sea el valor predeterminado para todos los elementos en nuestros [estilos base de preflight](/docs/preflight).
...
Esto significa que un elemento de 100px &times; 100px con un borde de 2px y 4px de padding en todos los lados se renderizará en realidad como 112px &times; 112px, con un área de contenido interna de 100px &times; 100px:
