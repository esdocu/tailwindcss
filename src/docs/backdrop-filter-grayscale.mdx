...
Utiliza utilidades como `backdrop-grayscale-50` y `backdrop-grayscale` para controlar el efecto de escala de grises aplicado al fondo de un elemento:
...
<UsingACustomValue utility="backdrop-grayscale" value="0.5" name="escala de grises de fondo" />
