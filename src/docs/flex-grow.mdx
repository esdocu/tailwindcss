...
### Hacer crecer los elementos según un factor

Utiliza utilidades `grow-<number>` como `grow-3` para hacer que los elementos flex crezcan proporcionalmente según su factor de crecimiento, permitiéndoles ocupar el espacio disponible de forma relativa entre sí:
...
Utiliza `grow-0` para evitar que un elemento flex crezca:
...
<UsingACustomValue utility="grow" name="factor de crecimiento flex" value="25vw" />
