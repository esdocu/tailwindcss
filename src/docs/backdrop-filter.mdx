...
Utiliza utilidades como `backdrop-blur-xs` y `backdrop-grayscale` para aplicar filtros al fondo de un elemento:
...
Puedes combinar las siguientes utilidades de filtro de fondo: [desenfoque](/docs/backdrop-filter-blur), [brillo](/docs/backdrop-filter-brightness), [contraste](/docs/backdrop-filter-contrast), [escala de grises](/docs/backdrop-filter-grayscale), [rotación de matiz](/docs/backdrop-filter-hue-rotate), [inversión](/docs/backdrop-filter-invert), [opacidad](/docs/backdrop-filter-opacity), [saturación](/docs/backdrop-filter-saturate) y [sepia](/docs/backdrop-filter-sepia).

### Eliminar filtros

Utiliza la utilidad `backdrop-filter-none` para eliminar todos los filtros de fondo aplicados a un elemento:
