...
export const description = "Utilidades para establecer el tamaño en línea (inline-size) de un elemento.";
...
Utiliza utilidades `inline-<number>` como `inline-24` y `inline-64` para establecer un tamaño en línea fijo en un elemento basada en la escala de espaciado:
...
Utiliza utilidades `inline-full` o `inline-<fraction>` como `inline-1/2` y `inline-2/5` para dar a un elemento un tamaño en línea basado en porcentaje:
...
Utiliza utilidades como `inline-sm` e `inline-xl` para establecer un tamaño en línea fijo en un elemento basado en la escala de contenedores:
...
Utiliza la utilidad `inline-screen` para hacer que un elemento ocupe todo el tamaño en línea del viewport:
...
### Restablecer el tamaño en línea

Utiliza la utilidad `inline-auto` para eliminar el tamaño en línea asignado a un elemento bajo una condición específica, como en un punto de interrupción (breakpoint) particular:
...
<UsingACustomValue utility="inline" value="5px" name="tamaño en línea" variable="inline-size" />
