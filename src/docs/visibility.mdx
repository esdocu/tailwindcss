...
<Example padding={false}>
  {
    <div className="py-8">
      ...
      <div className="mt-10 mb-3 pl-4 text-sm font-medium text-gray-500 dark:text-gray-400">
        Ocultar una fila usando <code className="text-xs text-gray-700 dark:text-gray-300">`collapse`</code>
      </div>
      <table className="w-full border-collapse border-y border-gray-400 bg-white text-sm dark:border-gray-500 dark:bg-gray-800">
        <thead className="bg-gray-50 dark:bg-gray-700">
          <tr>
      ...
      <div className="mt-10 mb-3 pl-4 text-sm font-medium text-gray-500 dark:text-gray-400">
        Ocultar una fila usando <code className="text-xs text-gray-700 dark:text-gray-300">`hidden`</code>
      </div>
      <table className="w-full border-collapse border-y border-gray-400 bg-white text-sm dark:border-gray-500 dark:bg-gray-800">
        <thead className="bg-gray-50 dark:bg-gray-700">
          <tr>
