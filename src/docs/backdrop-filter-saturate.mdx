...
export const description = "Utilidades para aplicar filtros de saturación de fondo a un elemento.";
...
Utiliza utilidades como `backdrop-saturate-50` y `backdrop-saturate-125` para controlar la saturación del fondo de un elemento:
...
<UsingACustomValue utility="backdrop-saturate" value=".25" name="saturación de fondo" variable="backdrop-saturation" />
