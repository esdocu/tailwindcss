...
Utiliza utilidades `scale-<number>` como `scale-75` y `scale-150` para escalar un elemento en un porcentaje de su tamaño original:
...
Utiliza utilidades `scale-x-<number>` como `scale-x-75` y `-scale-x-150` para escalar un elemento en el eje x en un porcentaje de su ancho original:
...
Utiliza utilidades `scale-y-<number>` como `scale-y-75` y `scale-y-150` para escalar un elemento en el eje y en un porcentaje de su altura original:
...
Utiliza utilidades `-scale-<number>`, `-scale-x-<number>` o `-scale-y-<number>` como `-scale-x-75` y `-scale-125` para reflejar y reducir la escala de un elemento en un porcentaje de su tamaño original:
