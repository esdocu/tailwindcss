...
export const description = "Utilidades para controlar el desfase del subrayado de un texto.";
...
<Example>
  {
    <div className="flex flex-col gap-8 text-gray-900 dark:text-gray-200">
      <div>
        ...
        <p className="text-lg font-medium underline underline-offset-1">El veloz zorro marrón salta sobre el perro perezoso.</p>
      </div>
      <div>
        <div className="mb-3 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">underline-offset-2</div>
        <p className="text-lg font-medium underline underline-offset-2">El veloz zorro marrón salta sobre el perro perezoso.</p>
      </div>
      <div>
        <div className="mb-3 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">underline-offset-4</div>
        <p className="text-lg font-medium underline underline-offset-4">El veloz zorro marrón salta sobre el perro perezoso.</p>
      </div>
      <div>
        <div className="mb-3 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">underline-offset-8</div>
        <p className="text-lg font-medium underline underline-offset-8">El veloz zorro marrón salta sobre el perro perezoso.</p>
      </div>
    </div>
  }
</Example>
...
<p class="underline underline-offset-1">El veloz zorro marrón...</p>
<!-- [!code classes:underline-offset-2] -->
<p class="underline underline-offset-2">El veloz zorro marrón...</p>
<!-- [!code classes:underline-offset-4] -->
<p class="underline underline-offset-4">El veloz zorro marrón...</p>
<!-- [!code classes:underline-offset-8] -->
<p class="underline underline-offset-8">El veloz zorro marrón...</p>
```
