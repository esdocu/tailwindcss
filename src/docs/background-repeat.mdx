...
Utiliza la utilidad `bg-repeat` para repetir la imagen de fondo tanto vertical como horizontalmente:
...
Utiliza la utilidad `bg-repeat-x` para repetir la imagen de fondo solo horizontalmente:
...
Utiliza la utilidad `bg-repeat-y` para repetir la imagen de fondo solo verticalmente:
...
Utiliza la utilidad `bg-repeat-space` para repetir la imagen de fondo sin recortarla:
...
### Evitar el recorte y los espacios

Utiliza la utilidad `bg-repeat-round` para repetir la imagen de fondo sin recortarla, estirándola si es necesario para evitar espacios vacíos:
...
Utiliza la utilidad `bg-no-repeat` para evitar que se repita una imagen de fondo:
