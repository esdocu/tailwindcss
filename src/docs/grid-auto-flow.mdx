...
Utiliza utilidades como `grid-flow-col` y `grid-flow-row-dense` para controlar cómo funciona el algoritmo de colocación automática para un diseño de cuadrícula (grid):
