...
export const description = "Utilidades para controlar el estilo del cursor al pasar el mouse sobre un elemento.";
...
<Figure hint="Pasa el mouse sobre cada botón para ver el cambio de cursor">
...
<button class="cursor-pointer ...">Enviar</button>
<button class="cursor-progress ...">Guardando...</button>
<button class="cursor-not-allowed ..." disabled>Confirmar</button>
```
