...
export const description = "Utilidades para controlar el estilo del cursor al pasar el ratón sobre un elemento.";
...
<Figure hint="Pasa el ratón sobre cada botón para ver el cambio de cursor">
