...
<Example>
  {
    <div className="mx-auto w-full max-w-md text-gray-500 dark:text-gray-400">
      Una resolución más alta significa más que solo una imagen de mejor calidad. Con una pantalla Retina 6K,{" "}
      <a
      ...
      te da casi un 40 por ciento más de espacio en pantalla que una pantalla 5K.
    </div>
  }
</Example>
