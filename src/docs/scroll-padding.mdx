...
export const description = "Utilidades para controlar el desplazamiento de scroll de un elemento dentro de un contenedor snap.";
...
Utiliza utilidades `scroll-pt-<number>`, `scroll-pr-<number>`, `scroll-pb-<number>` y `scroll-pl-<number>` como `scroll-pl-4` y `scroll-pt-6` para establecer el desplazamiento de scroll de un elemento dentro de un contenedor snap:
...
Utiliza las utilidades `scroll-ps-<number>` y `scroll-pe-<number>` para establecer las propiedades lógicas `scroll-padding-inline-start` y `scroll-padding-inline-end`, que se mapean al lado izquierdo o derecho según la dirección del texto:
...
Utiliza las utilidades `scroll-pbs-<number>` y `scroll-pbe-<number>` para establecer las propiedades lógicas `scroll-padding-block-start` y `scroll-padding-block-end`, que se mapean al lado superior o inferior según el modo de escritura:
...
Para usar un valor de scroll padding negativo, antepón un guion al nombre de la clase para convertirlo en un valor negativo:
