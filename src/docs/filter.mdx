...
export const description = "Utilidades para aplicar filtros a un elemento.";
...
Utiliza utilidades como `blur-xs` y `grayscale` para aplicar filtros a un elemento:
...
Puedes combinar las siguientes utilidades de filtro: [blur](/docs/filter-blur), [brightness](/docs/filter-brightness), [contrast](/docs/filter-contrast), [drop-shadow](/docs/filter-drop-shadow), [grayscale](/docs/filter-grayscale), [hue-rotate](/docs/filter-hue-rotate), [invert](/docs/filter-invert), [saturate](/docs/filter-saturate) y [sepia](/docs/filter-sepia).

### Eliminar filtros

Utiliza la utilidad `filter-none` para eliminar todos los filtros aplicados a un elemento:
