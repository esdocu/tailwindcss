...
export const description = "Utilidades para controlar el tamaño de fuente (font-size) de un elemento.";
...
<p class="text-sm ...">El veloz zorro marrón ...</p>
<p class="text-base ...">El veloz zorro marrón ...</p>
<p class="text-lg ...">El veloz zorro marrón ...</p>
<p class="text-xl ...">El veloz zorro marrón ...</p>
<p class="text-2xl ...">El veloz zorro marrón ...</p>
```

</Figure>

### Establecer la altura de línea (line-height)

Utiliza utilidades como `text-sm/6` y `text-lg/7` para establecer el tamaño de fuente y la altura de línea de un elemento al mismo tiempo:
...
<UsingACustomValue element="p" utility="text" name="tamaño de fuente" value="14px" variable="text-size" dataType="length" />
...
<CustomizingYourTheme utility="text" name="tamaño de fuente" customValue="0.625rem" customName="tiny">
