...
export const description = "Utilidades para especificar las filas en un diseño de cuadrícula.";
...
### Especificar las filas de cuadrícula

Utiliza utilidades `grid-rows-<number>` como `grid-rows-2` y `grid-rows-4` para crear cuadrículas con _n_ filas de igual tamaño:
...
Utiliza la utilidad `grid-rows-subgrid` para adoptar las pistas de filas definidas por el elemento padre:
...
<UsingACustomValue utility="grid-rows" name="filas" value="200px_minmax(900px,1fr)_100px" />
