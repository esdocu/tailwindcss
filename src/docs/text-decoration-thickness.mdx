...
Usa utilidades `decoration-<number>` como `decoration-2` y `decoration-4` para cambiar el grosor de la [decoración de texto](/docs/text-decoration-line) de un elemento:
...
<Example>
  {
    <div className="flex flex-col gap-8 text-gray-900 dark:text-gray-200">
      <div>
        ...
        <p className="text-lg font-medium underline decoration-1">El veloz zorro marrón salta sobre el perro perezoso.</p>
      </div>
      <div>
        <div className="mb-3 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">decoration-2</div>
        <p className="text-lg font-medium underline decoration-2">El veloz zorro marrón salta sobre el perro perezoso.</p>
      </div>
      <div>
        <div className="mb-3 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">decoration-4</div>
        <p className="text-lg font-medium underline decoration-4">El veloz zorro marrón salta sobre el perro perezoso.</p>
      </div>
    </div>
  }
</Example>
...
<p class="underline decoration-1">El veloz zorro marrón...</p>
<!-- [!code classes:decoration-2] -->
<p class="underline decoration-2">El veloz zorro marrón...</p>
<!-- [!code classes:decoration-4] -->
<p class="underline decoration-4">El veloz zorro marrón...</p>
```
