...
export const description = "Utilidades para aplicar filtros de desenfoque de fondo a un elemento.";
...
Utiliza utilidades como `backdrop-blur-sm` y `backdrop-blur-lg` para controlar el desenfoque de fondo de un elemento:
...
<UsingACustomValue utility="backdrop-blur" value="2px" name="desenfoque de fondo" />
...
<CustomizingYourTheme utility="backdrop-blur" themeKey="blur" name="desenfoque de fondo" customName="2xs" customValue="2px" />
