...
export const description = "Utilidades para controlar el cuadro delimitador de la máscara de un elemento.";
...
Utiliza utilidades como `mask-clip-border`, `mask-clip-padding` y `mask-clip-content` para controlar el cuadro delimitador de la máscara de un elemento:
