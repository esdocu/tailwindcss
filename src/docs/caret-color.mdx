...
export const description = "Utilidades para controlar el color del cursor de inserción de texto.";
...
Utiliza utilidades como `caret-rose-500` y `caret-lime-600` para cambiar el color del cursor de inserción de texto:

<Figure hint="Haz foco en el área de texto para ver el nuevo color del cursor">
...
<UsingACustomValue element="textarea" utility="caret" value="#50d71e" name="color del cursor" variable="caret-color" />
