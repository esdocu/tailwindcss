...
export const description =
  "Utilidades para controlar cómo se debe mezclar la imagen de fondo de un elemento con su color de fondo.";
...
Utiliza utilidades como `bg-blend-multiply` y `bg-blend-soft-light` para controlar cómo se mezclan la imagen de fondo y el color de un elemento:
