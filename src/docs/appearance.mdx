    ...
    <div className="mx-auto max-w-sm items-center">
      <div className="my-6 flex">
        ...
        <div className="mx-6 text-sm font-semibold text-gray-900 dark:text-gray-200">
          Estilos predeterminados del navegador aplicados
        </div>
      </div>
      <div className="my-6 flex items-center">
        ...
        <div className="mx-6 text-sm font-semibold text-gray-900 dark:text-gray-200">Eliminar estilos predeterminados del navegador</div>
      </div>
    </div>
  }
</Example>
...
Esta utilidad se utiliza a menudo al crear componentes de formulario personalizados.
    ...
    <div className="mx-auto my-6 grid max-w-sm items-center justify-center gap-8">
      <div className="flex items-center">
        ...
        >
          ...
          Vuelve a la apariencia predeterminada
        </label>
      </div>
      <div className="flex items-center">
        <label
