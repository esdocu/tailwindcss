...
export const description = "Utilidades para controlar la perspectiva de un elemento al colocarlo en un espacio 3D.";
...
Utiliza utilidades como `perspective-normal` y `perspective-distant` para controlar qué tan cerca o qué tan lejos está el plano z de la pantalla:
...
Esto es como acercar o alejar una cámara de un objeto.

### Eliminar una perspectiva

Utiliza la utilidad `perspective-none` para eliminar una transformación de perspectiva de un elemento:
