...
Con elementos posicionados estáticamente, cualquier [desplazamiento (offset)](/docs/top-right-bottom-left) será ignorado y el elemento no actuará como referencia de posición para los hijos posicionados absolutamente.
...
Con elementos posicionados relativamente, cualquier [desplazamiento (offset)](/docs/top-right-bottom-left) se calcula en relación con la posición normal del elemento, y este actuará como referencia de posición para los hijos posicionados absolutamente.

### Posicionamiento absoluto de elementos

Utiliza la utilidad `absolute` para posicionar un elemento _fuera_ del flujo normal del documento, haciendo que los elementos vecinos actúen como si el elemento no existiera:
...
Con elementos posicionados absolutamente, cualquier [desplazamiento (offset)](/docs/top-right-bottom-left) se calcula en relación con el padre más cercano que tenga una posición distinta de `static`, y el elemento actuará como referencia de posición para otros hijos posicionados absolutamente.
...
<Figure hint="Desplázate por este elemento para ver el posicionamiento fijo en acción">
...
Con elementos posicionados fijos, cualquier [desplazamiento (offset)](/docs/top-right-bottom-left) se calcula en relación con la ventana de visualización (viewport) y el elemento actuará como referencia de posición para los hijos posicionados absolutamente:
...
<Figure hint="Desplázate por este elemento para ver el posicionamiento pegajoso en acción">
...
Con elementos posicionados de manera pegajosa (sticky), cualquier [desplazamiento (offset)](/docs/top-right-bottom-left) se calcula en relación con la posición normal del elemento, y este actuará como referencia de posición para los hijos posicionados absolutamente.
