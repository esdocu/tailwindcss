...
Utiliza la utilidad `mask-repeat` para repetir la imagen de máscara tanto vertical como horizontalmente:
...
Utiliza la utilidad `mask-repeat-x` para repetir la imagen de máscara solo horizontalmente:
...
Utiliza la utilidad `mask-repeat-y` para repetir la imagen de máscara solo verticalmente:
...
Utiliza la utilidad `mask-repeat-space` para repetir la imagen de máscara sin recortarla:
...
### Evitar recortes y huecos

Utiliza la utilidad `mask-repeat-round` para repetir la imagen de máscara sin recortarla, estirándola si es necesario para evitar huecos:
...
Utiliza la utilidad `mask-no-repeat` para evitar que una imagen de máscara se repita:
