...
export const description = "Utilidades para controlar si los hijos de un elemento se colocan en el espacio 3D.";
...
Usa `transform-3d` para posicionar los hijos en el espacio 3D:
...
Sin esto, cualquier hijo solo se transformará en el espacio 2D y no en el espacio 3D.
