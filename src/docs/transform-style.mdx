...
export const description = "Utilidades para controlar si los elementos hijos se colocan en un espacio 3D.";
...
Usa `transform-3d` para posicionar elementos hijos en un espacio 3D:
...
Sin esto, cualquier elemento hijo solo se transformará en el espacio 2D y no en el espacio 3D.
