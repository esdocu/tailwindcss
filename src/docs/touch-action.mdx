...
export const description = "Utilidades para controlar cómo se puede desplazar y hacer zoom en un elemento en pantallas táctiles.";
...
Usa utilidades como `touch-pan-y` y `touch-pinch-zoom` para controlar cómo se puede desplazar (paneo) y hacer zoom (pellizco) en un elemento en pantallas táctiles:

<Figure hint="Intenta desplazar estas imágenes en una pantalla táctil">
