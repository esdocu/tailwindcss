...
Utiliza utilidades como `bg-white`, `bg-indigo-500` y `bg-transparent` para controlar el color de fondo de un elemento:
...
Utiliza el modificador de opacidad de color para controlar la opacidad del color de fondo de un elemento:
...
<UsingACustomValue utility="bg" value="#50d71e" name="color de fondo" variable="color" />
