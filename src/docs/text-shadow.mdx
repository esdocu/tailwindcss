...
<Example padding={false}>
  {
    <div className="relative grid items-center justify-around gap-4 bg-linear-45 from-indigo-400 via-purple-500 to-pink-500 px-6 py-14 text-center text-2xl font-semibold text-white">
      <p className="relative text-shadow-2xs">El veloz zorro marrón salta sobre el perro perezoso.</p>
      <p className="relative text-shadow-xs">El veloz zorro marrón salta sobre el perro perezoso.</p>
      <p className="relative text-shadow-sm">El veloz zorro marrón salta sobre el perro perezoso.</p>
      <p className="relative text-shadow-md">El veloz zorro marrón salta sobre el perro perezoso.</p>
      <p className="relative text-shadow-lg">El veloz zorro marrón salta sobre el perro perezoso.</p>
    </div>
  }
</Example>
...
<p class="text-shadow-2xs ...">El veloz zorro marrón...</p>
<p class="text-shadow-xs ...">El veloz zorro marrón...</p>
<p class="text-shadow-sm ...">El veloz zorro marrón...</p>
<p class="text-shadow-md ...">El veloz zorro marrón...</p>
<p class="text-shadow-lg ...">El veloz zorro marrón...</p>
```
...
<Example padding={false}>
  {
    <div className="relative grid items-center justify-around gap-4 bg-linear-45 from-indigo-400 via-sky-400 to-emerald-400 px-6 py-14 text-center text-2xl font-semibold text-white">
      <p className="relative text-shadow-lg">El veloz zorro marrón salta sobre el perro perezoso.</p>
      <p className="relative text-shadow-lg/20">El veloz zorro marrón salta sobre el perro perezoso.</p>
      <p className="relative text-shadow-lg/30">El veloz zorro marrón salta sobre el perro perezoso.</p>
    </div>
  }
</Example>
...
<p class="text-shadow-lg ...">El veloz zorro marrón...</p>
<p class="text-shadow-lg/20 ...">El veloz zorro marrón...</p>
<p class="text-shadow-lg/30 ...">El veloz zorro marrón...</p>
```
...
<button class="text-sky-950 text-shadow-2xs text-shadow-sky-300 ...">Reservar demo</button>
