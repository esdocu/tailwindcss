...
export const description = "Utilidades para establecer el tamaño en línea máximo de un elemento.";
...
Utiliza utilidades `max-inline-<number>` como `max-inline-24` y `max-inline-64` para establecer un tamaño en línea máximo fijo para un elemento según la escala de espaciado:
...
Utiliza las utilidades `max-inline-full` o `max-inline-<fraction>` como `max-inline-1/2` y `max-inline-2/5` para dar a un elemento un tamaño en línea máximo basado en porcentaje:
...
Utiliza utilidades como `max-inline-sm` y `max-inline-xl` para establecer un tamaño en línea máximo fijo para un elemento según la escala de contenedores:
...
<UsingACustomValue utility="max-inline" value="220px" name="tamaño en línea máximo" variable="max-inline-size" />
