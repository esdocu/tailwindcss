...
export const description =
  "Utilidades para controlar cómo se posiciona el fondo de un elemento en relación con los bordes, el padding y el contenido.";
...
Utiliza las utilidades `bg-origin-border`, `bg-origin-padding` y `bg-origin-content` para controlar dónde se renderiza el fondo de un elemento:
