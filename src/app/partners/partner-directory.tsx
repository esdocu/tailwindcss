...
import { directoryCategories, categoryTranslations } from "@/lib/sponsors";
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-[3fr_7fr] lg:items-start lg:gap-20">
        <div>
          ...
          <p className="mt-8 text-lg/7 font-medium tracking-tight text-pretty">
            <strong className="font-medium text-gray-950 dark:text-white">Ecosistema de Tailwind CSS.</strong>{" "}
            <span className="text-gray-500 dark:text-gray-400">
              Explora las empresas que hacen posible Tailwind CSS.
            </span>
          </p>
        </div>
        <div>
