...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "article",
    title: "Últimas actualizaciones - Blog",
    description: "Todas las últimas noticias de Tailwind CSS, directo del equipo.",
...
export default async function Blog() {
  ...
  return (
    <div className="relative mx-auto mt-24 max-lg:max-w-2xl">
      ...
      <GridContainer>
        <h1 className="mx-2 text-6xl tracking-tighter text-balance sm:text-7xl lg:text-8xl">Últimas actualizaciones</h1>
      </GridContainer>

      <GridContainer className="mt-10">
        <p className="mx-2 text-lg">Todas las últimas noticias de Tailwind CSS, directo del equipo.</p>
      </GridContainer>
