  ...
  return (
    <>
      ...
      <div className="mt-20 flex flex-col gap-4 sm:mt-24">
        <GridContainer>
          <p className="font-mono text-sm/6 tracking-wider text-gray-400 uppercase">Minicurso de 5 partes</p>
          <h1 className="mt-2 text-5xl tracking-tighter text-balance text-white sm:text-8xl">
            Crea UIs que no apesten.
          </h1>
        </GridContainer>
        <GridContainer>
          <p className="max-w-2xl text-lg/7 font-medium text-gray-400">
            <strong className="font-medium text-white">Lecciones en video cortas y tácticas</strong> del creador de
            Tailwind CSS, entregadas directamente en tu bandeja de entrada{" "}
            <strong className="font-medium text-white">todos los días durante una semana</strong>.
          </p>
        </GridContainer>
        <GridContainer>
          <HeroActions
