...
export const tile: Tile = {
  title: "SolidJS",
  description: "Una herramienta para crear interfaces de usuario simples, eficientes y reactivas.",
  Logo,
};

export const page: Page = {
  title: "Instalar Tailwind CSS con SolidJS",
  description: "Configuración de Tailwind CSS en un proyecto SolidJS.",
};
...
export const steps: Step[] = [
  {
    ...
    body: (
      <p>
        Comienza creando un nuevo proyecto SolidJS si aún no tienes uno configurado. El enfoque más común es utilizar{" "}
        <a href="https://www.solidjs.com/guides/getting-started">la plantilla de SolidJS Vite</a>.
      </p>
    ),
    code: {
      name: "Terminal",
