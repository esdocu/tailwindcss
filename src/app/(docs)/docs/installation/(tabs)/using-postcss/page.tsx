...
export const metadata: Metadata = {
  title: "Instalación de Tailwind CSS con PostCSS",
  description:
...
const steps: Step[] = [
  {
    ...
    body: (
      <p>
        Instala <code>tailwindcss</code>, <code>@tailwindcss/postcss</code> y <code>postcss</code> a través de npm.
      </p>
    ),
    code: {
      name: "Terminal",
  ...
  {
    title: "Añade Tailwind a tu configuración de PostCSS",
    body: (
      <p>
        Añade <code>@tailwindcss/postcss</code> a tu archivo <code>postcss.config.mjs</code>, o donde se configure
        PostCSS en tu proyecto.
      </p>
    ),
    code: {
    ...
    <>
      <div id="content-wrapper" className="prose relative z-10 mb-10 max-w-3xl" data-content="true">
        <h3 data-title="true" className="sr-only">
          Instalación de Tailwind CSS como plugin de PostCSS
        </h3>
        <p>
          Instalar Tailwind CSS como plugin de PostCSS es la forma más fluida de integrarlo con frameworks como Next.js
          y Angular.
        </p>
      </div>
      <Steps steps={steps} />
      <div className="my-4 md:my-16">
        <Cta label="Explorar nuestras guías de frameworks" href="/docs/installation/framework-guides">
          ...
          con PostCSS puede ser un poco diferente en las distintas herramientas de compilación. Consulta nuestras guías
          de frameworks para ver si tenemos instrucciones más específicas para tu configuración particular.
        </Cta>
      </div>
    </>
  );
