    ...
    <div>
      ...
      <GridContainer>
        <p className="max-w-(--breakpoint-md) px-2 text-lg/7 font-medium text-gray-600 max-sm:px-4 dark:text-gray-400">
          Un framework CSS primero en utilidades repleto de clases como{" "}
          ...
          <span className="font-mono text-[1.0625rem] text-sky-500 dark:text-sky-400">rotate-90</span> que pueden ser
          compuestas para construir cualquier diseño, directamente en tu marcado.
        </p>
      </GridContainer>
                  ...
                  <code>
                    <code>
                      ...
                      <span className="line">
                        ...
                        />
                        <span style={SYMBOL}>&gt;</span>
                        <span style={{ color: "var(--color-slate-50)" }}>Guerra de Clases</span>
                        <span style={SYMBOL}>&lt;/</span>
                        <span style={ELEMENT}>span</span>
                        <span style={SYMBOL}>&gt;</span>
                      </span>
                      <span className="line">
                        ...
                        />
                        <span style={SYMBOL}>&gt;</span>
                        <span style={{ color: "var(--color-slate-50)" }}>Los Antipatrones</span>
                        <span style={SYMBOL}>&lt;/</span>
                        <span style={ELEMENT}>span</span>
                        <span style={SYMBOL}>&gt;</span>
                      </span>
