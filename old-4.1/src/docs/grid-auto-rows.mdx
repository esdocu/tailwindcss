...
export const description = "Utilidades para controlar el tamaño de las filas de la cuadrícula creadas implícitamente.";
...
Usa utilidades como `auto-rows-min` y `auto-rows-max` para controlar el tamaño de las filas de la cuadrícula creadas implícitamente:
