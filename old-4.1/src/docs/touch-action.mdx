...
export const description = "Utilidades para controlar cómo un elemento puede ser desplazado y ampliado en pantallas táctiles.";
...
Usa utilidades como `touch-pan-y` y `touch-pinch-zoom` para controlar cómo un elemento puede ser desplazado (panned) y ampliado (pinched) en pantallas táctiles:
