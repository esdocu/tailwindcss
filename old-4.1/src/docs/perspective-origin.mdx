...
export const description = "Utilidades para controlar el origen de la perspectiva de un elemento cuando se coloca en un espacio 3D.";
...
Usa utilidades como `perspective-origin-top` y `perspective-origin-bottom-left` para controlar dónde se ubica el punto de fuga de una perspectiva:
