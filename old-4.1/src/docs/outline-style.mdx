...
Usa utilidades como `outline-solid` y `outline-dashed` para establecer el estilo del contorno de un elemento:
...
### Ocultando un contorno

Usa la utilidad `outline-hidden` para ocultar el contorno predeterminado del navegador en los elementos enfocados, mientras conservas el contorno en el modo de colores forzados:
...
### Eliminando contornos

Usa la utilidad `outline-none` para eliminar por completo el contorno predeterminado del navegador en los elementos enfocados:
