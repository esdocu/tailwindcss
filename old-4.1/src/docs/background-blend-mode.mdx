...
export const description =
  "Utilidades para controlar cómo la imagen de fondo de un elemento debe mezclarse con su color de fondo.";
...
Usa utilidades como `bg-blend-difference` y `bg-blend-saturation` para controlar cómo se mezclan la imagen de fondo y el color de un elemento:
