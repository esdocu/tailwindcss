...
export const description = "Utilidades para controlar el ancho del contorno de un elemento.";
...
Usa utilidades `outline` u `outline-<number>` como `outline-2` y `outline-4` para establecer el ancho del contorno de un elemento:
