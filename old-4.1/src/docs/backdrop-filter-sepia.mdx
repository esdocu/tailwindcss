...
export const description = "Utilidades para aplicar filtros sepia de fondo a un elemento.";
...
Usa utilidades como `backdrop-sepia` y `backdrop-sepia-50` para controlar el efecto sepia aplicado al fondo de un elemento:
