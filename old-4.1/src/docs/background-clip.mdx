...
Usa las utilidades `bg-clip-border`, `bg-clip-padding` y `bg-clip-content` para controlar el cuadro delimitador del fondo de un elemento:
...
Usa la utilidad `bg-clip-text` para recortar el fondo de un elemento para que coincida con la forma del texto:
