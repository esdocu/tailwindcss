...
Usa utilidades como `blur-xs` y `grayscale` para aplicar filtros a un elemento:
...
Usa la utilidad `filter-none` para quitar todos los filtros aplicados a un elemento:
