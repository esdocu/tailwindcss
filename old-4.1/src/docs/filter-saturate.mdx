...
export const description = "Utilidades para aplicar filtros de saturación a un elemento.";
...
Usa utilidades como `saturate-50` y `saturate-100` para controlar la saturación de un elemento:
