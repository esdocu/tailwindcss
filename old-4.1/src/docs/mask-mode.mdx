...
export const description = "Utilidades para controlar el modo de máscara de un elemento.";
...
Usa las utilidades `mask-alpha`, `mask-luminance` y `mask-match` para controlar el modo de la máscara de un elemento:
