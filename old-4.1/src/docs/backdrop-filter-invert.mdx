...
export const description = "Utilidades para aplicar filtros de inversión de color de fondo a un elemento.";
...
Usa utilidades como `backdrop-invert` y `backdrop-invert-65` para controlar la inversión de color del fondo de un elemento:
